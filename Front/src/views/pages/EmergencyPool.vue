        ...
        <div class="col-12">
            <div class="card">
                ...
                >
                    <template #header>
                        <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
                            <h5 class="m-0">Emergency Pool</h5>
                    ...
                    <Column field="inventoryStatus" header="Devices" :sortable="true" headerStyle="width:14%; min-width:10rem;">
                        <template #body="slotProps">
                ...
                <Dialog v-model:visible="productDialog" :style="{ width: '450px' }" header="Product Details" :modal="true" class="p-fluid">
                    ...
                    <div class="field">
                        <label for="inventoryStatus" class="mb-3">Devices</label>
